...
public class EventDelegateDrawer : PropertyDrawer
{
    ...
    public override float GetPropertyHeight(SerializedProperty prop, GUIContent label)
    {
        ...
        float lines = (1 * lineHeight) + yOffset;
    ...
    public override void OnGUI(Rect rect, SerializedProperty prop, GUIContent label)
    {
        ...
        if (showGroup.boolValue)
        {
            ...
            lineRect = rect;
            lineRect.yMin = rect.yMin  + yOffset;
            ...
            target = EditorGUI.ObjectField(lineRect, "Mono", target, typeof(MonoBehaviour), true) as MonoBehaviour;
